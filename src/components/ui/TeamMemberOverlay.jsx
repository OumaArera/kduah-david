...
const TeamMemberOverlay = ({ member, onClose }) => {
  ...
  return (
    <div
      className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4 md:p-8 overflow-y-auto"
      onClick={onClose}
    >
      <div
          ...
          <div className="md:w-1/3 bg-gray-50 p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col items-start text-gray-600">
                ...
                <p className="ml-7 text-sm">{member.email}</p>
              </div>
              ...
              <div className="flex flex-col items-start text-gray-600">
                ...
                <p className="ml-7 text-sm">{member.contact}</p>
              </div>
            </div>
          </div>
